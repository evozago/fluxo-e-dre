...
export const SpreadsheetTemplates = ({ onTemplateDownload }: SpreadsheetTemplatesProps) => {
  ...
  const templates = {
    ...
    parcelas: {
      ...
      example: [
        "Empresa ABC", "Serviços de TI - Jan/2024", "1500.00", "15/02/2024", "Fornecedores", "PIX", "empresa@email.com", "Banco do Brasil", "001234", "Pagamento referente aos serviços prestados"
      ],
      instructions: [
        ...
        "Data Vencimento: Campo obrigatório. Formato: DD/MM/YYYY (ex: 15/02/2024)",
